...
CHANNEL_DISPLAY = {"email": "Email", "whatsapp": "WhatsApp", "sms": "SMS", "push": "Push"}
...
class AnalyticsChartsView(APIView):
    ...
    def get(self, request):
        ...
        for ch in ["email", "whatsapp", "sms", "push"]:
            ...
            if ch_comms_count == 0:
                ...
                if has_campaign:
                    ...
                    channel_performance.append(
                        {"channel": CHANNEL_DISPLAY.get(ch, ch.title()), "engagement": eng, "conversion": conv}
                    )
                else:
                    channel_performance.append(
                        {"channel": CHANNEL_DISPLAY.get(ch, ch.title()), "engagement": 0, "conversion": 0}
                    )
                continue
            ...
            channel_performance.append({
                "channel": CHANNEL_DISPLAY.get(ch, ch.title()),
        ...
        for stat in channel_stats:
            ...
            revenue_attribution.append({
                "channel": CHANNEL_DISPLAY.get(stat["channel"], stat["channel"].title()),
